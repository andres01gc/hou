  ...
  presionarIngresarServicio() {
    ...
    this.popdate.drawPop(
      ...
      (data: any): void => {
        ...
        var id = this.data.db.list('servicios').push(servicio).key;
    ...
    // this.popdate.drawPop(
    //   'Nuevo Servicio Paciente',
    //   'Servicio ingresado por xxx',
    ...
    //   },
    //   (result: any): void => {
    //     this.popdate.showToast('servicio cancelado');
    //   }
    // );
  }
}
