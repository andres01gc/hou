...
export class Otrofile {
  ...
  public info_local: any[] = [
    {
      tipo_item: 'pag', titulo: 'Información General',
      items:
        [
          {
            tipo_item: 'item', nombre: 'Identidad',
            items: [
              {
                tipo_item: 'input',
                type: 'text',
          ...
          {
            tipo_item: 'item', nombre: 'Contacto',
            items: [
              {
                tipo_item: 'input',
                type: 'text',
          ...
          {
            tipo_item: 'item', nombre: 'Información Personal',
            items: [
              {
                tipo_item: 'input',
                type: 'number',
    ...
    {
      tipo_item: 'pag', titulo: 'Datos Personales',
      items:
        [
          {
            tipo_item: 'item', nombre: 'Vida profesional',
            items: [
              {
                tipo_item: 'select',
                type: 'text',
          ...
          {
            tipo_item: 'item', nombre: 'Datos de los padres',
            items: [
              {
                tipo_item: 'referencia',
                nombre: 'Madre ',
          ...
          {
            tipo_item: 'item', nombre: 'Seguridad Social',
            items: [
              {
                tipo_item: 'select',
                type: 'text',
          ...
          {
            tipo_item: 'item', nombre: 'Referencias',
            items: [
              {
                tipo_item: 'referencia',
                nombre: 'Padre ',
    ...
    {
      tipo_item: 'pag', titulo: 'Anamnesis',
      items:
        [
          {
            tipo_item: 'item', nombre: 'Motivo',
            items: [
              {
                tipo_item: 'input',
                type: 'text',
          ...
          {
            tipo_item: 'item', nombre: 'Antecedentes Sociales',
            items: [
              {
                tipo_item: 'input',
                type: 'text',
          ...
          {
            tipo_item: 'item', nombre: 'Antecedentes médicos',
            items: [
              {
                tipo_item: 'multiple',
          ...
          {
            tipo_item: 'item', nombre: 'Antecedentes estomatológicos u odontológicos',
            items: [
              {
                tipo_item: 'multiple',
          ...
          {
            tipo_item: 'item', nombre: 'Hábitos',
            items: [
              {
                tipo_item: 'multiple',
                opciones: ['Rechina los dientes (bruxismo)', 'Succión digital', 'Comerse las uñas',
                  'Respirar por la boca', 'Apretar los dientes', 'Cigarrillo', 'Licor', 'Café', 'Drogas'],
                nombre: 'Situaciones',
                tam: 'l'
              },
              {
          ...
          {
            tipo_item: 'item', nombre: 'Hábitos de higiene oral',
            items: [
              {
                tipo_item: 'select',
                type: 'text',
    ...
    {
      tipo_item: 'pag', titulo: 'Revisión por sistemas',
      items:
        [
          {
            tipo_item: 'item', nombre: 'Sistema nervioso',
            items: [
              {
                tipo_item: 'multiple',
                opciones: ['Ansiedad', 'Irritabilidad', 'Sincopes', 'Convulsiones', 'Paresias', 'Cefaleas',
                  'Depresión', 'Lipotimias', 'Epilepsia', 'Neuralgias', 'Parálisis', 'Migraña', 'Accidente cerebro vascular'],
                nombre: '',
                tam: 'l'
              },
              {
          ...
          {
            tipo_item: 'item', nombre: 'Sistema Respiratorio',
            items: [
              {
                tipo_item: 'multiple',
          ...
          {
            tipo_item: 'item', nombre: 'Sistema Cardiovascular',
            items: [
              {
                tipo_item: 'multiple',
          ...
          {
            tipo_item: 'item', nombre: 'Sistema Gastrointestinal',
            items: [
              {
                tipo_item: 'multiple',
          ...
          {
            tipo_item: 'item', nombre: 'Sistema Endocrino',
            items: [
              {
                tipo_item: 'multiple',
          ...
          {
            tipo_item: 'item', nombre: 'Sistema Osteoarticular',
            items: [
              {
                tipo_item: 'multiple',
          ...
          {
            tipo_item: 'item', nombre: 'Piel y Anexos',
            items: [
              {
                tipo_item: 'multiple',
          ...
          {
            tipo_item: 'item', nombre: 'Comentarios',
            items: [
              {
                tipo_item: 'input',
                type: 'text',
    ...
    {
      tipo_item: 'pag', titulo: 'Examen físico',
      items:
        [
          {
            tipo_item: 'item', nombre: 'General',
            items: [
              {
                tipo_item: 'input',
                type: 'number',
          ...
          {
            tipo_item: 'item', nombre: 'Nariz y senos paranasales',
            items: [
              {
                tipo_item: 'select',
                type: 'text',
    ...
    {
      tipo_item: 'pag', titulo: 'Examen estomatológico',
      items:
        [
          {
            tipo_item: 'item', nombre: 'Extraoral',
            items: [
              {
                tipo_item: 'select',
                type: 'text',
          ...
          {
            tipo_item: 'item', nombre: 'Intraoral',
            items: [
              {
                tipo_item: 'input',
                type: 'text',
          ...
          tipo_item: 'item', nombre: 'Intraoral pt.2',
          items: [
            {
              tipo_item: 'input',
              type: 'text',
    ...
    {
      tipo_item: 'pag', titulo: 'Odontograma', items: {}
    },
    {
      tipo_item: 'pag', titulo: 'Periodontograma',
      items: {}
    }, {
      tipo_item: 'pag', titulo: 'Examen Periodontal',
      items:
        [
          {
            tipo_item: 'item', nombre: 'Estado',
            items: [
              {
                tipo_item: 'multiple',
                opciones: ['Sano'],
          ...
          tipo_item: 'item', nombre: 'Descripción radiográfica',
          items: [
            {
              tipo_item: 'input',
              type: 'text',
      ...
      tipo_item: 'pag', titulo: 'Diagnósticos',
      items:
        [
          {
            tipo_item: 'item', nombre: 'Diagnóstico general',
            items: [
              {
                tipo_item: 'select',
                type: 'text',
          ...
          tipo_item: 'item', nombre: 'Diagnóstico por diente',
          items: [
            {
              tipo_item: 'input',
              type: 'number',
      ...
      tipo_item: 'pag', titulo: 'Johnny Test',
      items:
        [
          {
            tipo_item: 'item', nombre: 'Identidad',
      ...
      tipo_item: 'pag', titulo: 'Final',
      items: [
        {
          tipo_item: 'item', nombre: '',
          items: []
        }]
    }
  ];
